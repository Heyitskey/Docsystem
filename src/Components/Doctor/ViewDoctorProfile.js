              ...
              <div class="doctor-widget">
                <div class="doc-info-left">
                  <div class="doctor-img">
                    <img src={`${process.env.PUBLIC_URL}/fileuploads/${docList?.profile_pic?.name}`} class="img-fluid" alt="User Image" />
                  </div>
                  <div class="doc-info-cont">
                    <h4 class="doc-name">{docList?.userId?.name}</h4>
                    <p class="doc-speciality">{docList?.qualification}</p>
                    <p class="doc-department"><img src="../assestpro/img/specialities/specialities-05.png" class="img-fluid" alt="Speciality" />{docList?.specialization}</p>
                    <div class="rating">
                ...
                <div class="doc-info-right">
                  ...
                  <div class="clinic-booking">
                    <Link to="/appoint" class="apt-btn">Book Appointment</Link>
                  </div>
                </div>
              </div>
            </div>
