                    ...
                    <div class="row g-4">
                        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="service-item bg-light rounded h-100 p-5">
                                ...
                                <Link to='/physician' class="btn" href=""><i class="fa fa-plus text-primary me-3"></i>Read More</Link>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="service-item bg-light rounded h-100 p-5">
                                ...
                                <Link to='/cardio' class="btn" href=""><i class="fa fa-plus text-primary me-3"></i>Read More</Link>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                            <div class="service-item bg-light rounded h-100 p-5">
                                ...
                                <Link to='/neuro' class="btn" href=""><i class="fa fa-plus text-primary me-3"></i>Read More</Link>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="service-item bg-light rounded h-100 p-5">
                                ...
                                <Link to='/ortho' class="btn" href=""><i class="fa fa-plus text-primary me-3"></i>Read More</Link>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="service-item bg-light rounded h-100 p-5">
                                ...
                                <Link to='/dentiest' class="btn" href=""><i class="fa fa-plus text-primary me-3"></i>Read More</Link>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                            <div class="service-item bg-light rounded h-100 p-5">
                                ...
                                <Link to='/lab' class="btn" href=""><i class="fa fa-plus text-primary me-3"></i>Read More</Link>
                            </div>
                        </div>
                    </div>
                </div>
